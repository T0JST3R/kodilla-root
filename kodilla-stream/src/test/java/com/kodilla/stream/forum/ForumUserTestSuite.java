...
import com.kodilla.stream.com.kodilla.stream.forum.ForumUser;
...
public class ForumUserTestSuite {
   ...
   public void  testGetLocationOfFriends(){
        ...
        Set<String> friends;
        friends = user1.getFriendsLocalization();
        //Then
        System.out.println(friends.size());
        friends.stream()
                .forEach(System.out::println);

        Assert.assertEquals(4, user1.getFriendsLocalization().size());
        Assert.assertTrue(user1.getFriendsLocalization().contains("Miami"));
        Assert.assertFalse(user1.getFriendsLocalization().contains("Brooklyn"));
    }

    @Test
    public void testGetLocalizationFriendsOfFriends(){
...
//When
        ...
        Assert.assertEquals(3 , user1.getLocationFriendsOfFriends().size());
        Assert.assertTrue(user1.getLocationFriendsOfFriends().contains("Washington"));
