package com.kodilla.patterns2.shoptest;
...
public class ShopServiceTestSuite {
    ...
    public void testShopFacade() {
        ...
        order.addItem(new ItemDto(1L, 1));
        order.addItem(new ItemDto(13L, 2));
        order.addItem(new ItemDto(12L, 23));
        order.addItem(new ItemDto(10L, 24));
        try {
            orderFacade.processOrder(order, 1L);
        } catch (OrderProcessingException e) {
            // businss exception - should be handled in real app
        }
    }
